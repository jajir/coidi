...
public class AuthenticationProcessorSreg11 extends
		AuthenticationProcessorSreg10 implements AuthenticationProcessor {
	...
	public AbstractMessage process(AuthenticationRequest authenticationRequest,
		...
		if (!keys.isEmpty()) {
			...
			for (String key : keys) {
				...
				if (SREG_FULLNAME.equals(sregKey)
						&& identity.getFullname() != null) {
