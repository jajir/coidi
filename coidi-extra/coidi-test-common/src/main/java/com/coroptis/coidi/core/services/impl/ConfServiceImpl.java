...
public class ConfServiceImpl implements ConfService {
	...
	private final static Logger logger = Logger.getLogger(ConfServiceImpl.class);
	...
	public ConfServiceImpl() {
		 ...
		 */
		this.systemPropertyConfigurationDirectory = System.getProperty(CONF_KEY_CONFIGURATION_DIRECTORY);
		if (systemPropertyConfigurationDirectory == null) {
			throw new ConfigurationException("system propety '" + CONF_KEY_CONFIGURATION_DIRECTORY + "' is null. "
					+ "Application don't know where to find" + " directory with configuration.");
		}
	}
	...
	public Resource getConfiguration(final String configurationName, final String fileExtension) {
		...
		String fileName = getConfigurationDirectory() + configurationName + "-" + getServerRole() + "." + fileExtension;
