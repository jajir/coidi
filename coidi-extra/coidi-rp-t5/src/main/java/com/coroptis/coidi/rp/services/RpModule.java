...
public class RpModule {
	...
	binder.bind(AssociationFactory.class, AssociationFactoryImpl.class);
	...
	binder.bind(AuthenticationVerificationService.class, AuthenticationVerificationServiceImpl.class);
