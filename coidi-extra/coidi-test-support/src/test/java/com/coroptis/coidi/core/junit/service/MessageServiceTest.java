...
public class MessageServiceTest extends BaseJunitTest {
	...
	public void testSign() throws Exception {
		...
		msg.put("openid.signed", "op_endpoint,claimed_id,identity,return_to,response_nonce,assoc_handle,mode");
	...
	public void bind(ServiceBinder binder) {
		binder.bind(MessageService.class, MessageServiceImpl.class).withId(SERVICE_NAME);
	}
