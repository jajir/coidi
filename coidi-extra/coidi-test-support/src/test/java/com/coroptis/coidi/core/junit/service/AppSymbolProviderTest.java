...
public class AppSymbolProviderTest extends BaseJunitTest {
	...
	public void testValueForSymbol() throws Exception {
		expect(services.getConfigurationService().getProperty("op.ipAddress")).andReturn("10.20.30.40");
		services.replay();
	...
	public void testValueForSymbol_notFound() throws Exception {
		expect(services.getConfigurationService().getProperty("op.ipAddress.notFound")).andReturn(null);
		services.replay();
