...
public class JunitAppModule {
	...
	public static void bind(ServiceBinder binder) {
		...
		binder.bind(ConfService.class, new EasyMockServicebuilder<ConfService>(services.getConfigurationService()));
		binder.bind(ConvertorService.class,
				new EasyMockServicebuilder<ConvertorService>(services.getConvertorService()));
		binder.bind(CryptographyService.class,
				new EasyMockServicebuilder<CryptographyService>(services.getCryptographyService()));
		binder.bind(MessageService.class, new EasyMockServicebuilder<MessageService>(services.getMessageService()));
	}
}
