...
public class XmlProcessingTest extends AbstractLocalJunitTest {
	...
	services.replay();
	String ret = xmlProcessing.getMetaContent(
		Files.toString(new File("src/test/resources/example1.html"),
			Charset.forName("UTF-8")), "x-xrds-location");
	...
	services.replay();
	String ret = xmlProcessing.getMetaContent(
		Files.toString(new File("src/test/resources/example2.html"),
			Charset.forName("UTF-8")), "x-xrds-location");
	...
	services.replay();
	String ret = xmlProcessing.getMetaContent(
		Files.toString(new File("src/test/resources/example3.html"),
			Charset.forName("UTF-8")), "x-xrds-location");
	...
	services.replay();
	String ret = xmlProcessing.getMetaContent(
		Files.toString(new File("src/test/resources/example4.html"),
			Charset.forName("UTF-8")), "x-xrds-location");
	...
	services.replay();
	String ret = xmlProcessing.getMetaContent(
		Files.toString(new File("src/test/resources/example5.html"),
			Charset.forName("UTF-8")), "x-xrds-location");
	...
	binder.bind(XmlProcessing.class, XmlProcessingImpl.class).withId(SERVICE_NAME);
    }
