...
public class AuthReqGoogleAttributeExchange implements AuthReq {
	...
	if (discoveryResult.getPreferedService().idPresent(OpenIdNs.TYPE_ATTRIBUTE_EXCHANGE_1_0)) {
	    authenticationRequest.put("ns.ax", OpenIdNs.TYPE_ATTRIBUTE_EXCHANGE_1_0);
		...
		authenticationRequest.put("ax.type.email", "http://axschema.org/contact/email");
	     ...
	     */
	    authenticationRequest.setIdentity("http://specs.openid.net/auth/2.0/identifier_select");
