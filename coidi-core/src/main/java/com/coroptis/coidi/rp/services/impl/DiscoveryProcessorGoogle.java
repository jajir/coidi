...
/**
 * This discovery processor allows user to use their email for login.
 * 
 * @author jan
 * 
 */
public class DiscoveryProcessorGoogle implements DiscoveryProcessor {
    ...
    private final static Logger logger = LoggerFactory.getLogger(DiscoveryProcessorGoogle.class);
