...
public class RpBinding extends CoreBinding {
    ...
    /**
     * @return {@link HttpTransportService}
     */
    ...
    /**
     * @return {@link AssociationFactory}
     */
    ...
    /**
     * @return {@link DiscoveryProcessor}
     */
    public DiscoveryProcessor getDiscoveryProcessor() {
	DiscoveryProcessor out = get(DiscoveryProcessor.class);
	if (out == null) {
	    out = new DiscoveryProcessorYadis(getHttpService(), getXrdsService(),
		    getXmlProcessing(), getDiscoverySupport());
    ...
    /**
     * @return {@link AuthReqPreconditions}
     */
    ...
    /**
     * @return {@link AuthRespDecoderOpenId}
     */
    ...
    /**
     * @return {@link AuthRespDecoderTerminator}
     */
    ...
    /**
     * @return {@link AuthRespOpenId20Verify}
     */
    ...
    /**
     * @return {@link AuthResponseDecoderChain}
     */
    ...
    /**
     * @return {@link AuthenticationVerificationService}
     */
