...
public abstract class OpBinding extends OpOpenIdDispatcherChainBinding {
	...
	public AuthProc getAuthProcIdentity20() {
		...
		if (out == null) {
			out = new AuthProcIdentity20(getConf(), getUserVerifier(), getNegativeResponseGenerator(),
					getIdentityNamesConvertor());
	...
	public AuthProc getAuthProcSreg10() {
		...
		if (out == null) {
			out = new AuthProcSreg10(getSregService(), getIdentityService(), getNegativeResponseGenerator());
	...
	public AuthProc getAuthProcSreg11() {
		...
		if (out == null) {
			out = new AuthProcSreg11(getIdentityService(), getSregService(), getNegativeResponseGenerator());
	...
	public AuthProc getAuthProcStateLessAssociation() {
		...
		if (out == null) {
			out = new AuthProcStateLessAssociation(getAssociationService(), getBaseAssociationDao(), getBaseNonceDao());
	...
	public AuthProc getAuthProcVerifyLoggedUser11Setup() {
		...
		if (out == null) {
			out = new AuthProcVerifyLoggedUser11Setup(getNegativeResponseGenerator(), getUserVerifier());
	...
	public AuthProc getAuthProcVerifyLoggedUser20Setup() {
		...
		if (out == null) {
			out = new AuthProcVerifyLoggedUser20Setup(getNegativeResponseGenerator(), getUserVerifier());
