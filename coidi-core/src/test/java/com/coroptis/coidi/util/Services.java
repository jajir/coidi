...
public class Services {
	...
	private final AssociationService associationService = EasyMock.createMock(AssociationService.class);
	private final BaseAssociationDao baseAssociationDao = EasyMock.createMock(BaseAssociationDao.class);
	...
	private final Object[] mocks = new Object[] { getBaseNonceDao(), getNonceService(), getSigningService(),
			...
			getBaseIdentityDao(),getUserVerifier(), getHttpSession(),getAssociation(),getNonce() };
