...
import com.coroptis.coidi.op.services.impl.AuthProcVerifyLoggedUser11;
...
import com.coroptis.coidi.op.services.impl.AuthProcVerifyLoggedUser20;
...
public class OpModule extends AbstractModule {
	...
	protected void configure() {
		...
		bind(AuthProc.class).annotatedWith(Names.named(AuthProc.AUTH_PROC_VERIFY_LOGGED_USER_11)).to(AuthProcVerifyLoggedUser11.class);
		bind(AuthProc.class).annotatedWith(Names.named(AuthProc.AUTH_PROC_VERIFY_LOGGED_USER_20)).to(AuthProcVerifyLoggedUser20.class);
		bind(AuthProc.class).annotatedWith(Names.named(AuthProc.AUTH_PROC_VERIFY_IDENTITY_SELECT_20)).to(AuthProcVerifyIdentitySelect20.class);
		bind(AuthProc.class).annotatedWith(Names.named(AuthProc.AUTH_PROC_VERIFY_IDENTITY_11)).to(AuthProcVerifyLoggedUser11.class);
